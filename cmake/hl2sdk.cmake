...
if(MSVC)
    ...
    if(MSVC_VERSION GREATER_EQUAL 1900)
        target_link_libraries(hl2sdk INTERFACE legacy_stdio_definitions)
    endif()
else()
    add_compile_definitions(
        COMPILER_GCC
...
if(LINUX)
    target_link_libraries(hl2sdk m)
endif()
...
foreach(path IN LISTS HL2SDK_INCLUDE_PATHS)
    target_include_directories(hl2sdk INTERFACE "${HL2SDK_PATH}/${path}")
endforeach()
...
if(UNIX)
    ...
    foreach(lib IN LISTS HL2SDK_ARCH_POSTLINK_LIBS)
        target_link_libraries(hl2sdk INTERFACE "${HL2SDK_PATH}/${lib}")
    endforeach()
    ...
    if(LINUX)
        ...
        if(HL2SDK_LINUX_USES_SYSTEM_CXX_LIBS)
            ...
            set_target_properties(hl2sdk PROPERTIES LINK_OPTIONS "${HL2SDK_LINK_OPTIONS}")
        endif()
    endif()
elseif(WIN32)
